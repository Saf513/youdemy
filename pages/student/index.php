 ...
 <div class="flex">
       <?php include '../common/sidebar.html'; ?>
        <main class="flex-1 p-6">
            <h1 class="text-3xl font-playfair font-bold mb-8">Tableau de Bord Étudiant</h1>
            <p>Bienvenue sur votre tableau de bord étudiant. Ici, vous pouvez voir les cours auxquels vous êtes inscrit.</p>
        </main>
    </div>
