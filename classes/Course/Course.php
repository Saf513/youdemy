...
class Course
{
    ...
    {
         if (isset($this->id)) {
            $query = "UPDATE courses SET title = :title, description = :description, content = :content, teacher_id = :author_id, category_id = :category_id, content_type = :content_type, content_url = :content_url,  status = :status, thumbnailUrl = :thumbnailUrl WHERE id = :id";
            $params = [
                'id' => $this->id,
                'title' => $this->title,
            ...
            return $result;
              ...
              $query = "INSERT INTO courses (title, description, content, teacher_id, category_id, created_at, content_type, content_url, status, thumbnailUrl) VALUES (:title, :description, :content, :author_id, :category_id, NOW(), :content_type, :content_url, :status, :thumbnailUrl)";
            $params = [
                 'title' => $this->title,
                'description' => $this->description,
                'content' => $this->content,
    ...
    public static function getCoursesByTeacherId(dataBase $db, int $teacherId): array
    {
        $query = "SELECT * FROM courses WHERE teacher_id = :teacher_id";
          $result = $db->executeQuery($query, ['teacher_id' => $teacherId]);
          $courses = [];
         if($result) {
